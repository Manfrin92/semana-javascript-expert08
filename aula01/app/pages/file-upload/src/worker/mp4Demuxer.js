...
export default class MP4Demuxer {
   ...
   * @param {number} info.timescale
   * @param {object[]} info.videoTracks
   * @param {number} info.videoTracks.id
   * @param {object} info.videoTracks.video
   * @param {number} info.videoTracks.video.width
   * @param {number} info.videoTracks.video.height
   *
   */
  #onReady(info) {
